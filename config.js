const fs = require('fs-extra') 
 ...
 global.location = 'Sri lanka, hettipola' 
 ...
 module.exports = { 
   botname:   process.env.BOT_NAME === undefined ? 'Blue-Lion 4flag team' : process.env.BOT_NAME, 
   ownername: process.env.OWNER_NAME === undefined ? 'janith' : process.env.OWNER_NAME,  
   author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'janith' : process.env.PACK_INFO.split(";")[0], 
...
voice  :  process.env.AUTO_VOICE === undefined ? true : process.env.AUTO_VOICE, 
   ...
   BRANCH: 'main',  
   ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'I am alive bro' : process.env.ALIVE_MESSAGE, 
